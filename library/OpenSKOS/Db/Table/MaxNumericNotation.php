 ...
 */
class OpenSKOS_Db_Table_MaxNumericNotation extends Zend_Db_Table
{
    protected $_name = 'max_numeric_notation';
     ...
     * @var string
     */
    protected $_rowClass = 'OpenSKOS_Db_Table_Row_MaxNumericNotation';
