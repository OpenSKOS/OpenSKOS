...
class Message {
  ...
  $user, $file, $setUri, $ignoreIncomingStatus, $importedConceptStatus, $isRemovingDanglingConceptReferencesRound, $noUpdates = false, $toBeChecked = false, $fallbackLanguage = null, $clearSet = false, $deleteSchemes = false
  ) {
    $this->file = $file;
    $this->setUri = $setUri;
