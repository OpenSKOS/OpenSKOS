...
class Document
{
     ...
     */
    protected $mapping = [
        Skos::PREFLABEL => ['s_prefLabel', 't_prefLabel', 'a_prefLabel', 'sort_s_prefLabel', 'prefLabel'],
        Skos::ALTLABEL => ['s_altLabel', 't_altLabel', 'a_altLabel', 'sort_s_altLabel', 'altLabel'],
        Skos::HIDDENLABEL => ['s_hiddenLabel', 't_hiddenLabel', 'a_hiddenLabel', 'sort_s_hiddenLabel', 'hiddenLabel'],
        Skos::DEFINITION => ['t_definition', 'a_definition', 'definition'],
        Skos::EXAMPLE => ['t_example', 'a_example', 'example'],
        Skos::CHANGENOTE => ['t_changeNote', 'a_changeNote', 'changeNote'],
        ...
        OpenSkos::TOBECHECKED => ['b_toBeChecked', 'toBechecked'],
        DcTerms::CREATOR => ['s_creator', 'creator'],
        DcTerms::DATESUBMITTED => ['d_dateSubmited','dateSubmitted'],
        DcTerms::CONTRIBUTOR => ['s_contributor', 'contributor'],
