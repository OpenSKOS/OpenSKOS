...
EditorSearch = new Class({
    ...
    initialize: function (searchForm, searchResults) {
        ...
        // Pagination
        this.searchResults.getElement('.more-results').addEvent('click', function (ev) {
            ev.stop();
        ...
        this.searchResults.getElement('.add-all-to-selection').addEvent('click', function (ev) {
            ev.stop();
            self.addAllSearchResultsToSelection();
        });
    ...
    handleScrolling: function () {
        if ($('left-bottom-panel')) {
            var self = this;
            $('left-bottom-panel').addEvent('scroll', function () {
                self.scrollingResults($('left-bottom-panel'));
            });
        }
    },
