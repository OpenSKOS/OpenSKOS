...
var EditorView = new Class({
    ...
    showDeleteBox: function (uri) {
        ...
        deleteBox.getElement('form').addEvent('submit', function (e) {
            e.stop();
    ...
    showCreateConfirmationBox: function (doExist) {
        ...
        confirmationBox.getElement('[name=yes]').addEvent('click', function (e) {
            e.stop();
            SqueezeBox.close();
            Editor.Control.saveConcept();
        });
        confirmationBox.getElement('[name=no]').addEvent('click', function (e) {
            e.stop();
            SqueezeBox.close();
        });
